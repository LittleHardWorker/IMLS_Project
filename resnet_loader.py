...
from resnet import resnet, resnet_plus
...
def load_ResNet(version='18', pretrained=False, include_top=False, cifar10=False, weight_decay=None):
    ...
    if version == '18':
        ...
        ResNet_50 = resnet_plus.ResNet_50()
        output = ResNet_50.call(inputs)
    elif version == 'ResNeXt_50':
        ResNeXt_50 = resnet_plus.ResNeXt_50()
        output = ResNeXt_50.call(inputs)
    else:
