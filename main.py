...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='18', help="Specify the ResNet model to be used; either 18, 34, 50 or ResNeXt_50")
    ...
    parser.add_argument('--temperature', type=float, default=0.5, help="Sets the temperature for cross-entropy loss function")
    parser.add_argument('--strength', type=float, help="Sets the strength of augmentations")
    parser.add_argument('--new_aug', type=int, default=0, help="Whether to use new augmentation opeator. The order is 1:random_HSV_in_YIQ, 2:dense_image_warp, 3:euc_dist_trans, 4:sharpness, 5:all")
    parser.add_argument('--proj_head_act', type=str, default='relu', help="What kind of activation function of projection head to use. It can be relu, sigmoid, softmax adn tanh")
    ...
    config.proj_head_act = args.proj_head_act

    if args.new_aug == 1:
        config.random_HSV_in_YIQ = True
    elif args.new_aug == 2:
        config.dense_image_warp = True
    elif args.new_aug == 3:
        config.euc_dist_trans = True
    elif args.new_aug == 4:
        config.sharpness = True
    elif args.new_aug == 5:
        config.random_HSV_in_YIQ = True
        config.dense_image_warp = True
        config.sharpness = True
